...
// then the next interval will be the lower half of the current interval. If the value of the target 
...
function binarySearch(array, number, beginning, end){
    var middle = Math.floor(array.length / 2);
    if(middle === number){
        return array;
    }
    if(array[middle] > array[index].values()){
